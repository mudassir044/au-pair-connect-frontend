        ...
        <div className="container px-4 text-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              <Button size="lg" variant="outline" className="border-white/80 bg-transparent !text-white hover:bg-white hover:!text-primary dark:border-white/80 dark:bg-transparent dark:!text-white dark:hover:bg-white dark:hover:!text-primary" asChild>
